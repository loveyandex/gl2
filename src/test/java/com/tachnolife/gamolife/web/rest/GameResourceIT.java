...
class GameResourceIT {
    ...
    public static Game createEntity(EntityManager em) {
        Game game = new Game().name(DEFAULT_NAME);
        return game;
    }
    ...
    public static Game createUpdatedEntity(EntityManager em) {
        Game game = new Game().name(UPDATED_NAME);
        return game;
    }
    ...
    void getAllGamesWithEagerRelationshipsIsEnabled() throws Exception {
        when(gameRepositoryMock.findAllWithEagerRelationships(any())).thenReturn(new PageImpl(new ArrayList<>()));
