...
import com.tachnolife.gamolife.repository.GameRepository;
...
/**
 * REST controller for managing {@link com.tachnolife.gamolife.domain.Game}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class GameResource {
    ...
    @Autowired
    private GamerRepository gamerResource;
    ...
    public ResponseEntity<Game> getGame(@PathVariable Long id) {
        ...
        Optional<Game> game = gameRepository.findOneWithEagerRelationships(id);
